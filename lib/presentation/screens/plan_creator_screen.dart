...
import 'package:master_plan/data/data_layer.dart';
import 'package:master_plan/presentation/provider/plan_provider.dart';
import 'package:master_plan/presentation/screens/plan_screen.dart';
...
class _PlanCreatorScreenState extends State<PlanCreatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Master Plans Rizqi')),
      body: Column(
